 ...
 * @author Mabeesha
 */
public class CongestiveHeartFailure_past_data_Learner 
{
    ...
    public CongestiveHeartFailure_past_data_Learner(ArrayList<Double>[] pastData,int arraySize)
    {
    ...
    private void learn()
    {
        ...
        //System.out.println("past data learning finished, algorithm :- gradien descent");
        //System.out.println("hypothesisParameters;");
        for(int i = 0; i < 10; i++) {
        	OutputString += hypothesisParameters[i] + " ";
        }
        //OutputString = hypothesisParameters[0]+" "+hypothesisParameters[1]+" "+hypothesisParameters[2]+" "+hypothesisParameters[3]+" "+hypothesisParameters[4]+" "+hypothesisParameters[5]+" "+hypothesisParameters[6];
        double z = 0;
        for( int k = 0 ; k < training_data_arraySize-1 ; k++ )                                  //calculatingg z
        {
            z = z + hypothesisParameters[k]*training_data[k].get(0);
        }  
        System.out.println("your risk is " + ( 1.0 / (1.0 + Math.exp(-z)) )*100+"% for conjestive");
    }
